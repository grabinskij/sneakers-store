                ...
                <div className="terms-container">
                    ...
                    <div id="terms-eng">
                        <div className="terms-box">
                            <div className="terms-box__button-wrapper">
                                <div className="terms-box__button">
                    ...
                    <p>The following information provides a brief overview of how your personal data is handled when you
                        visit this
                    ...
                    <p>Data collection on this website is carried out by the website operator. The contact details of the
                        operator are
                        available in the Legal Notice of this website.
                    </p>

                    <p>Your data is either transmitted by you or automatically collected, or after your consent when
                        visiting the
                    ...
                    <p>Some of the data is collected to ensure the proper functioning of the website. Other data may be used
                        to analyze
                        your user behavior.
                    </p>

                    <p>You have the right to obtain free information about the origin, recipient, and purpose of your stored
                        personal
                        data at any time. You also have the right to request the correction or deletion of this data. If you
                        have
                        consented to the processing of your data, you can revoke this consent at any time. Under certain
                        circumstances,
                        you also have the right to request the restriction of the processing of your personal data, as well
                        as the right
                    ...
                    <p>Our website is hosted on an external hosting service. The personal data collected on this website is
                        stored on
                        the servers of the host(s). This includes, among other things, IP addresses, contact requests, meta
                        and
                        communication data, contract data, contact details, names, website access, and other data generated
                        by the use
                        of a website.
                    </p>

                    <p>The external hosting is carried out for the purpose of providing our site securely, quickly, and
                        efficiently by a
                        professional provider. If consent has been obtained, processing is carried out exclusively on the
                        basis of the
                    ...
                    <p>We take the protection of your personal data very seriously. We treat your data confidentially and in
                        accordance
                        with the statutory data protection regulations and this privacy policy.
                    </p>

                    <p>When using this website, various personal data is collected. This privacy policy explains what data
                        we collect
                        and for what purpose. We point out that data transmission over the Internet (e.g., when
                        communicating by email)
                        may have security vulnerabilities. Complete protection of data against access by third parties is
                        not
                        possible.
                    </p>

                    <p>The processing of data on this website is the responsibility of the website operator. The contact
                        details of the
                    ...
                    <p>You have the right to have data that we process automatically based on your consent transmitted to
                        you or to a
                        third party in a common, machine-readable format. If technically feasible, we can also arrange for
                        the transfer
                    ...
                    <p>You have the right to obtain information free of charge at any time about your stored personal data,
                        its origin,
                        recipient, and the purpose of data processing. You may also have the right to correct incorrect data
                        or have
                    ...
                    <p>You have the right to restrict the processing of your personal data in certain situations. Please
                        contact us at
                    ...
                    <h2>Cookies</h2>
                    <p>This website uses &quot;cookies&quot;. These small data records are stored on your device and do not
                        cause any
                        harm. There
                        are temporary cookies that are only stored during your browsing session, and permanent cookies that
                        remain on
                        your device until you delete them or they are automatically removed.
                    </p>
                    <p>Cookies can originate from us (first-party cookies) or from third parties (third-party cookies).
                        Third-party
                    ...
                    <h2>Contact Form</h2>
                    <p>When you contact us via the contact form, the information and contact details you provide will be
                        stored to
                        process your request and respond to any follow-up inquiries. This data will not be disclosed without
                        your
                        consent.
                    </p>
                    <p>The processing of the data entered into the contact form is based exclusively on your consent (Art. 6
                        para. 1
                        lit. a GDPR). You can revoke this consent at any time by sending us an informal message by email.
                        The legality
                        of the data processing operations carried out until the revocation remains unaffected by the
                        revocation.
                    </p>
                    <p>The data you enter in the contact form will remain with us until you request deletion, revoke your
                        consent, or
                    ...
                    <p>When using the comment function, the time of creation and, if not posted anonymously, the chosen
                        username are
                        stored in addition to your comment.
                    </p>
                    <p>Comments and the associated data are stored on this website until the commented content is completely
                        deleted or
                        must be deleted for legal reasons.
                    </p>
                    <p>The storage of comments is based on your consent. You can revoke this consent at any time without
                        affecting the
                    ...
                    <h2>Google Fonts</h2>
                    <p>This website uses so-called Google Fonts provided by Google for the consistent display of fonts. When
                        a page is
                        loaded,
                        the necessary fonts are loaded into the browser cache to correctly display texts and fonts. Your
                        browser must
                        establish
                        a connection to Google&apos;s servers for this purpose. As a result, Google becomes aware that this
                        website has been
                        accessed
                        via your IP address. The use of Google Fonts is in accordance with Art. 6 para. 1 lit. f GDPR. The
                        website
                        operator has
                        a legitimate interest in the uniform presentation of the typeface on their website. If consent has
                        been
                        requested,
                        the processing is carried out exclusively in accordance with Art. 6 para. 1 lit. a GDPR and § 25
                        para. 1 TTDSG,
                        to the
                        extent that the consent includes the storage of cookies or access to information on the user&apos;s
                        terminal device
                        (e.g., device
                        fingerprinting) within the meaning of the TTDSG. Consent can be revoked at any time. If your browser
                        does not
                        support Google
                    ...
                    <h2>Font Awesome</h2>
                    <p>This site uses Font Awesome for consistent font and icon display. The provider is Fonticons, Inc.,
                        located at 6
                        Porter Road Apartment 3R, Cambridge, Massachusetts, USA. When loading a page, the necessary fonts
                        are loaded
                        into the browser cache to display text, fonts, and icons correctly. Your browser must establish a
                        connection to
                        Font Awesome&apos;s servers for this purpose. Font Awesome thus becomes aware that this website has
                        been
                        accessed via
                        your IP address. The use of Font Awesome is in accordance with Art. 6 para. 1 lit. f GDPR. We have a
                        legitimate
                        interest in the consistent presentation of the typeface on our website. If appropriate consent has
                        been
                        obtained, processing is carried out exclusively in accordance with Art. 6 para. 1 lit. a GDPR and §
                        25 para. 1
                        TTDSG, insofar as the consent includes the storage of cookies or access to information on the
                        user&apos;s
                        device
                        (e.g., device fingerprinting) as defined in the TTDSG. Consent can be revoked at any time. If your
                        browser does
                    ...
                    <h2>Google Maps</h2>
                    <p>This website uses the Google Maps mapping service provided by Google LLC, 1600 Amphitheatre Parkway,
                        Mountain
                        View, CA 94043, USA. To use the Google Maps features, it is necessary to store your IP address. This
                        information
                        is usually transmitted to a Google server in the USA and stored there. The website operator has no
                        influence on
                        this data transmission. When Google Maps is activated, Google may use Google Fonts for consistent
                        font display.
                        When Google Maps is accessed, your browser loads the required web fonts into the browser cache to
                        display text
                        and fonts correctly. The use of Google Maps is in the interest of an appealing presentation of our
                        online offers
                        ...
                        fingerprinting) as
                        defined in the TTDSG. Consent can be revoked at any time. Data transfer to the USA is based on the
                        Standard
                    ...
                    <p>We use the Bootstrap CSS framework via the jsDelivr Content Delivery Network (CDN), provided by
                        Volentio JSD
                        Limited, located at Suite 2a1, Northside House, Mount Pleasant, Barnet, England, EN4 9EB. We
                        integrate the
                        Bootstrap CSS framework on our website to optimize the display of our content on various devices and
                        improve
                        loading times. The jsDelivr CDN is a service that provides content such as libraries and frameworks,
                        including
                        the Bootstrap framework. The integration of Bootstrap via the jsDelivr CDN serves to protect our
                        legitimate
                        interests in accordance with Art. 6 para. 1 lit. f GDPR. If your browser has JavaScript enabled and
                        no
                    ...
                    <p>The provider&apos;s privacy policy for jsDelivr can be found at:
                        <a href="https://www.jsdelivr.com/privacy-policy-jsdelivr-net/"
                           target="_blank"
                           rel="noopener noreferrer">https://www.jsdelivr.com/privacy-policy-jsdelivr-net</a>
                    </p><br/><br/>

                    <h2>jQuery</h2>
                    <p>To further optimize loading times, we also include jQuery on our website. When you visit our website,
                        program
                        libraries are retrieved and downloaded from servers of the provider Google LLC, located at 1600
                        Amphitheatre
                        Parkway, Mountain View, CA 94043, USA, via the Google Content Delivery Network. Personal data (e.g.,
                        your IP
                        address and browser) is transmitted to Google in the process. The integration of jQuery serves to
                        protect our
                        legitimate interests in accordance with Art. 6 para. 1 lit. f GDPR.
                    </p>
                    <p>For more information on how Google handles user data, please see Google&apos;s Privacy Policy at:
                        <a href="https://www.google.com/policies/privacy"
                           target="_blank" rel="noopener noreferrer">https://www.google.com/policies/privacy</a>
                    </p><br/><br/>
                    ...
                    <p>We use Firebase Authentication from Google in our applications, a service for authentication.
                        Firebase
                        Authentication allows us to simplify the login process by using third-party identity services and
                        storing the
                        corresponding information on its platform. This service acts as an intermediary for data collection
                        between
                        third parties and ourselves. The data collected by Firebase Authentication is stored on our behalf
                        so that we
                        can use and process it for our apps. The personal data collected includes email address and
                        password. In these
                        cases, processing is carried out in accordance with your consent pursuant to Art. 6 para. 1 lit. a
                        GDPR.
                    </p>
                    ...
                    <h2>Google OAuth</h2>
                    <p>Google OAuth, provided by Google LLC, is a service for logging in and authenticating closely linked
                        to the Google
                        network. This service allows users to log in to various applications and websites using their Google
                        login
                    ...
                    <h2>jsDelivr CDN</h2>
                    <p>To speed up content delivery on our website, we use the Content Delivery Network (CDN) from jsDelivr,
                        operated by
                        Volentio JSD Limited, located at Suite 2a1, Northside House, Mount Pleasant, Barnet, England, EN4
                        9EB. A CDN is
                        a service that delivers large media files such as graphics or scripts more quickly via regionally
                        distributed
                        servers. We use the CDN solely for the purpose of improving the loading times and security of our
                        website. Your
                        browser must establish a connection to the CDN&apos;s servers to retrieve the content, thereby
                        allowing
                        the CDN to
                        become aware that our website has been accessed via your IP address. The use of the CDN is based on
                        our
                    ...
                    <div id="terms-de">
                        <div className="terms-box">
                            ...
                            <h1 className="terms-title">Datenschutzerklärung</h1>
                            <ButtonHome/>
                        </div>
                    </div>

                    <h2>Allgemeine Hinweise</h2>
                    <p>Die nachfolgenden Informationen bieten eine kurze Übersicht darüber, wie mit Ihren persönlichen Daten
                        umgegangen
                        wird, wenn Sie diese Website besuchen. Persönliche Daten sind alle Daten, die dazu genutzt werden
                        können, Sie
                    ...
                    <p>Die Datenerfassung auf dieser Website erfolgt durch den Betreiber der Website.Die Kontaktdaten des
                        Betreibers
                        sind im Impressum dieser Website verfügbar.
                    </p>

                    <p>Ihre Daten werden entweder von Ihnen übermittelt oder automatisch erfasst, bzw. nach Ihrer
                    ...
                    <p>Ein Teil der Daten wird erhoben, um die fehlerfreie Bereitstellung der Website zu gewährleisten.
                        Andere Daten
                    ...
                    <p>Unsere Website befindet sich auf einem externen Hosting-Service. Die personenbezogenen Daten,
                        die auf dieser
                    ...
                    <p>Das externe Hosting erfolgt zum Zweck im Interesse einer sicheren, schnellen und effizienten
                        Bereitstellung
                    ...
                    <p>Wir nehmen den Schutz Ihrer persönlichen Daten sehr ernst. Wir behandeln Ihre Daten
                        vertraulich und gemäß den
                        gesetzlichen Datenschutzvorschriften sowie dieser Datenschutzerklärung.
                    </p>

                    <p>Bei der Nutzung dieser Website werden verschiedene personenbezogene Daten erhoben. Diese
                    ...
                    <p>Die Verarbeitung von Daten auf dieser Website liegt in der Verantwortung des
                        Websitebetreibers.
                    ...
                    <p>Sie haben jederzeit das Recht, gemäß den geltenden Gesetzen kostenfrei Auskunft über Ihre
                        gespeicherten
                    ...
                    <p>Sie haben das Recht, die Verarbeitung Ihrer persönlichen Daten in bestimmten Situationen
                    ...
                    <h2>Cookies</h2>
                    <p>Auf dieser Website verwenden wir &quot;Cookies&quot;. Diese kleinen Datensätze werden auf Ihrem Gerät
                        gespeichert und
                    ...
                    <p>Cookies können entweder von uns (First-Party-Cookies) oder von Drittanbietern
                    ...
                    <p>Wenn Sie uns über das Kontaktformular kontaktieren, werden die von Ihnen angegebenen
                        Informationen und
                    ...
                    <p>Die von Ihnen im Kontaktformular hinterlegten Daten werden bei uns gespeichert, bis Sie uns
                        zur Löschung
                    ...
                    <p>Bei Nutzung der Kommentarfunktion werden neben Ihrem Kommentar auch der Zeitpunkt der
                        Erstellung sowie, sofern
                        nicht anonym gepostet wird, der gewählte Nutzername gespeichert.
                    </p>
                    <p>Kommentare und die dazugehörigen Daten werden auf dieser Website gespeichert, bis der
                        kommentierte Inhalt
                        vollständig gelöscht wird oder aus rechtlichen Gründen gelöscht werden muss.
                    </p>
                    <p>Die Speicherung von Kommentaren erfolgt aufgrund Ihrer Einwilligung. Sie können diese
                    ...
                    <h2>Google Fonts</h2>
                    <p>Für die konsistente Darstellung von Schriftarten verwendet diese Seite sogenannte Google
                    ...
                    <p>Weitere Informationen zu Google Fonts finden Sie unter der Datenschutzerklärung von Google
                        unter:
                    ...
                    <h2>Font Awesome</h2>
                    <p>Für die konsistente Darstellung von Schriftarten und Symbolen verwendet diese Seite Font
                    ...
                    <p>Weitere Informationen zu Font Awesome finden Sie in der Datenschutzerklärung von Font Awesome
                        unter:
                    ...
                    <h2>Google Maps</h2>
                    <p>Diese Website verwendet den Kartendienst Google Maps, bereitgestellt von der Google LLC, 1600
                        Amphitheatre
                        Parkway,
                        Mountain View, CA 94043, USA.
                    </p>
                    <p>Zur Nutzung der Google Maps-Funktionen ist es erforderlich, Ihre IP-Adresse zu speichern.
                        Diese Informationen
                    ...
                    <p>Die Nutzung von Google Maps erfolgt im Interesse einer ansprechenden Darstellung der
                    ...
                    <p>Die Datenübertragung in die USA erfolgt auf Basis der Standardvertragsklauseln der
                    ...
                    <p>Wir verwenden das Bootstrap-CSS-Framework über das jsDelivr Content Delivery Network (CDN),
                        bereitgestellt von
                    ...
                    <h2>jQuery</h2>
                    <p>Zur weiteren Optimierung der Ladezeiten binden wir auf unserer Website auch die jQuery ein.
                        Dabei werden beim
                    ...
                    <p>Wir setzen in unseren Anwendungen Firebase Authentication von Google ein, einen Dienst zur
                        Authentifizierung.
                    ...
                    <p>Weitere Informationen zum Datenschutz finden Sie in den Datenschutzbestimmungen von Google
                        unter:
                        <a href="https://policies.google.com/privacy"
                           target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy</a>
                    </p><br/>
                    ...
                    <h2>Google OAuth</h2>
                    <p>Google OAuth, bereitgestellt von Google LLC, ist ein Dienst zur Anmeldung und
                    ...
                    <p>Die Art der erhobenen personenbezogenen Daten umfasst verschiedene Datenarten, darunter
                    ...
                    <h2>jsDelivr CDN</h2>
                    <p>Um die Auslieferung von Inhalten auf unserer Website zu beschleunigen, verwenden wir das
                    ...
                    <p>Ein CDN ist ein Dienst, der große Mediendateien wie Grafiken oder Skripte über regional
                        verteilte Server
                        schneller bereitstellt. Wir nutzen das CDN allein zum Zweck der Verbesserung der Ladezeiten
                        und der Sicherheit
                        unserer Website.
                    </p>
                    <p>Ihr Browser muss eine Verbindung zu den Servern des CDNs herstellen, um die Inhalte
                        abzurufen, wodurch das CDN
                        Kenntnis davon erlangt, dass unsere Website über Ihre IP-Adresse aufgerufen wurde.
                    </p>
                    <p>Die Nutzung des CDNs erfolgt auf der Grundlage unserer berechtigten Interessen an einer
