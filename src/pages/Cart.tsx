...
const Cart: React.FC = () => {
    ...
    const onClickClear = () => {
        if(window.confirm('Remove the cart?')){
            dispatch(clearItems())
        }
    }
        ...
        <div className="container container--cart">
            <div className="cart">
                ...
                <div className="content__items">
                    {
                        items.map((item: any) => <CartItem key={item.id + item.size} {...item} />)
                    }
                </div>
                <div className="cart__bottom">
                    <div className="cart__bottom-details">
                        <span> Amount: <b>{totalCount}</b> </span>
                        <span> Total order sum: <b>{totalPrice} $</b> </span>
                    </div>
                    <div className="cart__bottom-buttons">
                            <Link to="/" className="button button--black button--outline button--add go-back-btn">
