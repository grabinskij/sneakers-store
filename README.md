...
- **Product Browsing**: View and search for sneakers in a user-friendly interface.
...
- **Redux Toolkit**: For managing application state with a simplified and efficient approach.
- **TypeScript**: Adds static typing to JavaScript, improving code quality and maintainability.
- **Firebase**: Provides authentication services and real-time database capabilities.
...
To view the SneakerX shop on your local machine, follow these steps:

1. **Clone this repository**:
   ```bash
   git clone https://github.com/grabinskij/sneakers-store.git
